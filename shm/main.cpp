...
void SellBuyTest1() {
    ...
    std::cout << "itm1 name: " << itm1.getName() << ", amount: " << itm1.getAmount() << ", base price: " << itm1.getBasePrice() << ", price: " << itm1.getPrice() << ", rarity: " << itm1.getTestRarity() << "\n";
    std::cout << "itm2 name: " << itm2.getName() << ", amount: " << itm2.getAmount() << ", base price: " << itm2.getBasePrice() << ", price: " << itm2.getPrice() << ", rarity: " << itm2.getTestRarity() << "\n";
    std::cout << "itm3 name: " << itm3.getName() << ", amount: " << itm3.getAmount() << ", base price: " << itm3.getBasePrice() << ", price: " << itm3.getPrice() << ", rarity: " << itm3.getTestRarity() << "\n";
