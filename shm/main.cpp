...
int main()
{
    ...
    Island il1(Coordinates (1, 2), time_ptr);
    Island il2(Coordinates (2, 3), time_ptr);
    Island il3(Coordinates (3, 4), time_ptr);
    ...
    Cargo * c2 = store.storeCargo.at(1);
    Cargo * c3 = store.storeCargo.at(2);
